...
pub static PATTERN_CASES: &[(&str, &str, usize)] = &[
    ("no-chain", "No sign-ups, no downloads, no hassle — just paste and go.", 1),
    ("no-chain", "The plan has no hidden fees and no long-term contracts.", 1),
    ("no-chain", "No fluff, no filler, no jargon, no corporate buzzwords.", 1),
    ("no-chain", "There is no catch here, honestly.", 0),
    ("no-chain", "It ships with no bells and whistles, no fluff.", 1),
    ("no-chain", "No, no, I insist.", 0),
    ("no-chain", "no no no", 0),
    ("no-chain", "with no list patterns at all, so nothing lights up.", 0),
    ("no-chain", "NO FEES, NO CONTRACTS, NO SURPRISES", 1),
    ("no-chain", "no fluff; no filler", 1),
    ("no-chain", "no time, no money, no way to say no thanks", 1),
    ("no-chain", "no-code, no-fuss setup", 1),
    ...
    ("did-not-chain", "Did not flinch, did not blink, did not apologize.", 1),
    ("did-not-chain", "He didn't call and didn't write.", 1),
    ("did-not-chain", "She did not go.", 0),
    ("did-not-chain", "Did not know why, did not care.", 1),
    ...
    ("echo-triad", "A shopping cart is an object in the system. A chat room is an object in the system.", 1),
    ("echo-triad", "The parser is a state machine. The renderer is a state machine. The scheduler is a state machine.", 1),
    ...
    ("stacked-questions", "Do I know how it works? Where it breaks? Which corners it cut?", 1),
    ("stacked-questions", "Was it worth it? Would I do it again?", 1),
    ("stacked-questions", "Did it work? Yes, and then some.", 0),
    ("stacked-questions", "What changed?", 0),
    ("sentence-anaphora", "Maybe nobody needed it. Maybe the timing was off. Maybe both.", 1),
    ...
    ("sentence-anaphora", "Everything changed. Everything slowed down. Everything cost more.", 1),
